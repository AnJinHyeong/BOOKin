         ...
         <div class="cart-contents">
            ...
            <div class="cart">            
                  ...
                  <div class="cart-left">                    
                           ...
                           <table class="cart-table">
                              ...
                              <tbody>
                                 ...
                                 <tr class="goods-form">
                                    ...
                                    <td>
                                       <div class="cart-count">
                                          <button type="button" name="button" class="mi"><img src="<%=root %>/image/minus-solid.svg" alt="minus" class="amount-image"/></button>
                                    <input type="text" value="<%=cartListDto.getCartAmount()%>" id="<%=cartListDto.getCartNo()%>">   
                                 <button type="button" name="button" class="pl"><img src="<%=root %>/image/plus-solid.svg" alt="plus" class="amount-image"/></button>                                 
                                       </div>
                                    </td>
                                    ...
                                    <td>
                                       <span class="c1">
                                         판매가 : <%=cartListDto.getBookPrice() %>
                                       </span>
                                       <span class="c2">
                                          할인가 : <%=cartListDto.getBookDiscount() %>
                                       </span>
                                    </td>
                        ...
                        <div class="btnbox right"> 
                           <input type="button" class="allCheck" value="전체상품 선택" id="btn-s-black">
                            <button class="btn-s-black" type="button" >선택상품 삭제</button>
                            <button class="btn-s-black" type="button" >전체상품 삭제</button>
                        </div>
